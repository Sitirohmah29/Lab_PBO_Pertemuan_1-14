...
//        		textGender.setBounds(105,154,169, 30); 
...
//        		JTextField textCitizenship = new JTextField(); 
//        		textCitizenship.setBounds(105,104,169, 30); 
...
//            if (textFullname.getText().isEmpty() || textEmail.getText().isEmpty() || txtPhone.getText().isEmpty() || textGender.getText().isEmpty() || textCitizenship.getText().isEmpty()) {
...
//    	    students.setullname(textFullname.getText());
